...
void Output::paintEvent(QPaintEvent *)
{
    ...
    if(!delayed){
        ...
        painter.drawText(QRect(160,15,160,20),Qt::AlignLeft,motorRStatus);
        painter.drawText(QRect(160,30,160,20),Qt::AlignLeft,motorLStatus);
    }else
    {
        painter.drawText(QRect(0,15,320,40),Qt::AlignHCenter,message);
    }if(showMessage)
    {
        painter.drawText(QRect(0,220,320,40),Qt::AlignHCenter,message2);
    }
    painter.end();
}
