...
static int  serial_open(char *serial_name, speed_t baud)
{
...
static void serial_send(int serial_fd, char *data, int size)
{
  write(serial_fd, data, size);
}
static int  serial_read(int serial_fd, char *data, int size, int timeout_usec)
{
  fd_set fds;
